...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_INIT_PRIORITY, 50);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SEGGER_RTT_UART_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_DIABLO_CONTROL_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_BMI08X_SENSOR_API_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_VL53L5CX_SENSOR_API_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MICROCDR_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_DIABLO_CONTROL_A2V2_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HAL_NXP_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MICROXRCEDDS_CLIENT_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_EXTENDED_MODES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MAX_STD_ID_FILTER, 14);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MAX_EXT_ID_FILTER, 7);

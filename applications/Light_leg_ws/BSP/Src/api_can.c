...
int c_light_canfd_send(){
    ...
    ret = can_send(CanPort, &frame, K_SECONDS(1), NULL, NULL);
...
int api_canfd_init(){
    ...
    const struct can_filter cf = {
        .id = 0x200, .mask = 0x1ff, .flags = CAN_FILTER_DATA};
